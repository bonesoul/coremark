...
PCI_DEVTABLE	PciDevTable [] =
{
	...
	{ 0x8086, 0x24C5, "Realtek ALC268 ", "RealTek" } ,
	...
	{ 0x8086, 0x266D, "82801EB", "Carte audio Analog Devices AD1981HD @ Intel 82801fbich 6 - High Definition Audio Controller [b-1]]" } ,
	...
	{ 0x8086, 0x27d8, "PCI\\VEN_8086&DEV_27D8&SUBSYS_02201028&REV_01\\3&172", "Microsoft UAA Bus HD Audio" } ,
	...
	{ 0x8086, 0x29A4, "n/a", "The IntelÃ¯Â¿Â½ Management Engine provides thermal management for IntelÃ¯Â¿Â½ Desktop Boards." } ,
	...
	{ 0x8086, 0x8086, "0x8086&DEV_7191&SUBSYS_00000000&REV_03", "PCI\\VEN_8086&DEV_24**&SUBSYS_47428086&REV_02\\3&61AAA01&0&FB	28" } ,
	...
	{ 0x14F1, 0x2C06, "10250093", "HDAUDIO Soft Data fax Modem with SmartPC" } ,
	...
	{ 0x14F1, 0x5045, "1179FF31", "High Definition Audio Func01" } ,
	...
	{ 0x168C, 0x001c, "VGN-N320E", "Atheros AR5007EG Wireless network adapter" } ,
	...
	{ 0x1002, 0x4380, "ATI ?", "AHCI Controller" } ,
	...
	{ 0x1002, 0x9581, "634866", "ATI Mobility Radeon HD2600" } ,
	...
	{ 0x1002, 0x95c4, "ATI Mobility™ Radeon® HD 3470", "ATI Mobility™ Radeon® HD 3470" } ,
	...
	{ 0x1023, 0x9685, "ProVIDIA 96859685", "2MB VGA" } ,
	...
	{ 0x104C, 0x8036, "PCI6515", "Texas Instruments PCIx515 Cardbus Controller" } ,
	...
	{ 0x104C, 0x9066, "?", "Hawking HWP54G 802.11b/g Wireless PCI Adapter (Rev T2)" } ,
	...
	{ 0x104C, 0xAC13, "PCI9440", "PCI\\VEN_104C&DEV_803b" } ,
	...
	{ 0x10EC, 0x8167, "-8168", "PCI Gigabit Ethernet" } ,
	...
	{ 0x1106, 0x7372, "VT8237S", "SATA RAID" } ,
	...
	{ 0x14E4, 0x165A, "5722", "Broadcom Gigabit Ethernet (HP ML110 G5)" } ,
	...
	{ 0x14E4, 0x4315, "BCM4310", "Dell Wireless 1395 WLAN Mini-Card" } ,
	...
	{ 0x1186, 0x0100, "dl10038d", "Ethernet Adapter" } ,
	...
	{ 0x11AB, 0x4632, "88E8055", "Marvell Yukon 88E8055 PCI-E Gigabit Ethernet Controller" } ,
	{ 0x11AB, 0x13F8, "W8300", "802.11 Adapter" } ,
	{ 0x11AB, 0x1fa6, "88W8310", "The Libertasâ„¢ WLAN 80211bg" } ,
	{ 0x11AB, 0x1FAA, "8335", "Marvell Libertas 802.11b/g Wireless (8335)" } ,
	{ 0x11AB, 0x4320, "88E8055", "Marvell Yukon PCI E Gigabit" } ,
	...
	{ 0x11BD, 0xBEBE, "51015777", "pinnacle, bendino V1.0A" } ,
	...
	{ 0x11D1, 0x520, "tag4769", "Video card" } ,
...
http://forum.osdev.org/viewtopic.php?f=1&t=17339&p=132359#p132359
http://forum.osdev.org/viewtopic.php?f=1&t=17526&p=132096&hilit=PCI#p132096
...
uint16 pci_read_word ( uint16 bus, uint16 dev, uint16 func, uint16 offset)
{
	outl(0xCF8,((unsigned long) 0x80000000 | (unsigned long)(bus<<16) | (unsigned long)(dev<<11) | (unsigned long) (func << 8) | (offset & 0xfc) ));
	return (uint16)((inl(0xCFC) >> ((offset & 2) * 8)) & 0xffff);
}

	char * find_vendor(uint16 vend_id)
	{
		// search for vendor
			int i=0;
			...
			while(1)
			{
					if( PciVenTable[i].VenId == 0xffff ) // end of table , no matches!
						return NULL;
				  				
					if( PciVenTable[i].VenId == vend_id )
	...
	char * find_device(uint16 vendor,uint16 id)
	{
		int i;
		for(i=0;i<PCI_DEVTABLE_LEN;i++)
			if((PciDevTable[i].VenId==vendor) && (PciDevTable[i].DevId==id))
...
void scan_pci_devices()
{
	...
	{
		  ret->VendorID = (uint16) (pci_read(bus,dev,func,0)&0x0000FFFF); 
			ret->DeviceID = (uint16)((pci_read(bus,dev,func,0)&0xFFFF0000) >> 16);
					
		if ( ret->VendorID!= 0xFFFF)
		{						
						char * str_vendor=find_vendor(ret->VendorID);
						if (str_vendor!=NULL)
						{
								char * str_device=find_device(ret->VendorID,ret->DeviceID);
								printk("[PCI] found %s %s..\n",str_vendor,str_device);
						}
					  else
					 			printk("[PCI] found unknown device vendor: 0x%x device: 0x%x ..\n",ret->VendorID,ret->DeviceID);
		}
	}
}
